...
public class RangeReplicatingPartitionExchangePOperator extends AbstractExchangePOperator {
    ...
    public RangeReplicatingPartitionExchangePOperator(List<OrderColumn> partitioningFields, INodeDomain domain, RangeId rangeId,
    ...
    public Pair<IConnectorDescriptor, TargetConstraint> createConnectorDescriptor(IConnectorDescriptorRegistry spec,
        ...
        ITupleMultiPartitionComputerFactory tpcf = new FieldRangePartitionComputerFactory(sortFields, rangeComps,
                rangeType);
