...
public class MetadataPrimaryIndexes {
	...
	public static void init() throws MetadataException {
		...
		DATAVERSE_DATASET = new MetadataIndex("Dataverse", null, 2,
				new IAType[] { BuiltinType.ASTRING },
				new String[] { "DataverseName" },
				MetadataRecordTypes.DATAVERSE_RECORDTYPE);

		DATASET_DATASET = new MetadataIndex("Dataset", null, 3, new IAType[] {
				BuiltinType.ASTRING, BuiltinType.ASTRING }, new String[] {
				"DataverseName", "DatasetName" },
				MetadataRecordTypes.DATASET_RECORDTYPE);

		DATATYPE_DATASET = new MetadataIndex("Datatype", null, 3, new IAType[] {
				BuiltinType.ASTRING, BuiltinType.ASTRING }, new String[] {
		...
		NODE_DATASET = new MetadataIndex("Node", null, 2,
				new IAType[] { BuiltinType.ASTRING },
				new String[] { "NodeName" },
				MetadataRecordTypes.NODE_RECORDTYPE);

		NODEGROUP_DATASET = new MetadataIndex("Nodegroup", null, 2,
				new IAType[] { BuiltinType.ASTRING },
				new String[] { "GroupName" },
				MetadataRecordTypes.NODEGROUP_RECORDTYPE);
