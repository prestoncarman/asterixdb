...
import org.apache.asterix.runtime.operators.joins.intervalindex.AbstractStreamJoiner.TupleStatus;
...
public class IntervalForwardSweepJoiner extends AbstractStreamJoiner {
    ...
    public IntervalForwardSweepJoiner(IHyracksTaskContext ctx, int memorySize, int partition,
        ...
        runFileStream[LEFT_PARTITION] = new RunFileStreamDir(ctx, "ifsj-left", branchStatus[LEFT_PARTITION]);
        runFileStream[RIGHT_PARTITION] = new RunFileStreamDir(ctx, "ifsj-right", branchStatus[RIGHT_PARTITION]);
    ...
    public void processJoin(IFrameWriter writer) throws HyracksDataException {
        ...
        System.out.println(",IntervalForwardSweepJoiner Statistics Log," + partition + ",partition," + memorySize
                ...
                + runFileStream[RIGHT_PARTITION].getTupleCount() + ",right tuple_count," + joinSideCount[LEFT_PARTITION]
    ...
    private void unfreezeAndContinue(int frozenPartition, ITupleAccessor accessor) throws HyracksDataException {
        ...
        if (accessor != null && accessor.exists()) {
            ...
            runFileStream[frozenPartition].startReadingRunFile(accessor,
                    runFilePointer[frozenPartition].getFileOffset());
