...
public class BuiltinFunctions {
    ...
    public static final FunctionIdentifier INTERMEDIATE_KURTOSIS = FunctionConstants.newAsterix("agg-intermediate-kurtosis", 1);
    public static final FunctionIdentifier UNION_INTERVAL_RANGE = FunctionConstants.newAsterix("agg-union_interval_range", 1);
    public static final FunctionIdentifier LOCAL_UNION_INTERVAL_RANGE = FunctionConstants.newAsterix("agg-local-union_interval_range", 1);
    public static final FunctionIdentifier INTERMEDIATE_UNION_INTERVAL_RANGE = FunctionConstants.newAsterix("agg-intermediate-union_interval_range", 1);
    public static final FunctionIdentifier GLOBAL_UNION_INTERVAL_RANGE = FunctionConstants.newAsterix("agg-global-union_interval_range", 1);
    public static final FunctionIdentifier INTERVAL_RANGE_MAP = FunctionConstants.newAsterix("interval-range-map", 3);
    ...
    public static final FunctionIdentifier SCALAR_LOCAL_FIRST_ELEMENT = FunctionConstants.newAsterix("local-first-element", 1);
    public static final FunctionIdentifier SCALAR_UNION_INTERVAL_RANGE = FunctionConstants.newAsterix("union_interval_range", 1);
    ...
    public static final FunctionIdentifier INTERMEDIATE_SQL_MAX = FunctionConstants.newAsterix("agg-intermediate-sql-max", 1);
    public static final FunctionIdentifier SQL_UNION_INTERVAL_RANGE = FunctionConstants.newAsterix("agg-sql-union_interval_range", 1);
    public static final FunctionIdentifier LOCAL_SQL_UNION_INTERVAL_RANGE = FunctionConstants.newAsterix("agg-local-sql-union_interval_range", 1);
    public static final FunctionIdentifier INTERMEDIATE_SQL_UNION_INTERVAL_RANGE = FunctionConstants.newAsterix("agg-intermediate-sql-union_interval_range", 1);
    public static final FunctionIdentifier GLOBAL_SQL_UNION_INTERVAL_RANGE = FunctionConstants.newAsterix("agg-global-sql-union_interval_range", 1);
    ...
    public static final FunctionIdentifier SCALAR_SQL_UNION_INTERVAL_RANGE = FunctionConstants.newAsterix("sql-union_interval_range", 1);
    ...
    public static final FunctionIdentifier INTERVAL_CONSTRUCTOR_START_FROM_DATETIME = FunctionConstants.newAsterix("interval-start-from-datetime", 2);
    ...
    public static final FunctionIdentifier GET_OVERLAPPING_INTERVAL = FunctionConstants.newAsterix("get-overlapping-interval", 2);
    public static final FunctionIdentifier INTERVAL_JOIN_REMOVE_DUPLICATES = FunctionConstants.newAsterix("interval-join-remove-duplicates", 3);
