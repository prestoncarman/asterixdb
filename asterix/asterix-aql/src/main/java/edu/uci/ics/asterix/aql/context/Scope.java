...
public final class Scope {
     ...
     */
    public void addFunctionDescriptor(FunctionIdentifier fd, boolean varargs) {
     ...
     */
    public FunctionIdentifier findFunctionSignature(String name, int arity) {
        FunctionIdentifier fd = null;
        if (functionSignatures != null) {
