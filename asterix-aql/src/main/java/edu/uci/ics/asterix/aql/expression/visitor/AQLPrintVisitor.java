...
public class AQLPrintVisitor implements IAqlVisitorWithVoidReturn<Integer> {
	...
	public void visit(DatasetDecl dd, Integer step) throws AsterixException {
		if (dd.getDatasetType() == DatasetType.INTERNAL) {
			...
			out.println(skip(step) + "DatasetDecl" + dd.getName() + "("
					+ dd.getItemTypeName() + ")" + "is an feed dataset");
		}
	}
	...
	@Override
	public void visit(WriteFromQueryResultStatement stmtLoad, Integer arg)
			throws AsterixException {
		// TODO Auto-generated method stub
	...
	@Override
	public void visit(ControlFeedStatement ss, Integer step)
			throws AsterixException {
		out.println(skip(step) + ss.getOperationType() + skip(step)
				+ ss.getDatasetName());
	}
	...
	@Override
	public void visit(BeginFeedStatement stmtDel, Integer arg)
			throws AsterixException {
		// TODO Auto-generated method stub
