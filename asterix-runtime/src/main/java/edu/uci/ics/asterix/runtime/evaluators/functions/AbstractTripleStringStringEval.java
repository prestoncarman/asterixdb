 ...
 * @author Xiaoyu Ma
 */
public abstract class AbstractTripleStringStringEval implements IEvaluator  {
    ...
    public AbstractTripleStringStringEval(DataOutput dout, IEvaluatorFactory eval0,
