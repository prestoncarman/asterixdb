        ...
        return new IEvaluatorFactory() {
            ...
            public IEvaluator createEvaluator(IDataOutputProvider output) throws AlgebricksException {
                ...
                return new AbstractTripleStringBoolEval(dout, args[0], args[1], args[2]) {
                    ...
                    private IBinaryComparator strComp = AqlBinaryComparatorFactoryProvider.INSTANCE.getBinaryComparatorFactory(BuiltinType.ASTRING, OrderKind.ASC).createBinaryComparator();
