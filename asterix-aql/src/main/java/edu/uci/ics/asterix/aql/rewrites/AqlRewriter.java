...
public final class AqlRewriter {
	...
	private FunctionDecl lookupUserDefinedFunctionDecl(
	...
	private boolean isBuiltinFunction(FunctionSignature functionSignature) {
		if (AsterixBuiltinFunctions
				.isBuiltinCompilerFunction(new FunctionIdentifier(
						FunctionConstants.ASTERIX_NS, functionSignature
								.getName(), functionSignature.getArity()))) {
			return true;
		}
		...
		if (AsterixBuiltinFunctions
				.isBuiltinCompilerFunction(new FunctionIdentifier(
						...
						functionSignature.getName(), functionSignature
								.getArity()))) {
			return true;
		}
	...
	private static class GatherFunctionCalls implements
		...
		@Override
		public Void visitDieClause(DieClause lc, Void arg)
				throws AsterixException {
		...
		@Override
		public Void visitWriteFromQueryResultStatement(
				WriteFromQueryResultStatement stmtLoad, Void arg)
				throws AsterixException {
			// TODO Auto-generated method stub
			return null;
		}
		...
		@Override
		public Void visitLoadFromQueryResultStatement(
				WriteFromQueryResultStatement stmtLoad, Void arg)
				throws AsterixException {
			// TODO Auto-generated method stub
			return null;
		...
		@Override
		public Void visitControlFeedStatement(ControlFeedStatement del, Void arg)
				throws AsterixException {
			// TODO Auto-generated method stub
			return null;
		}
		...
		@Override
		public Void visitBeginFeedStatement(BeginFeedStatement bf, Void arg)
				throws AsterixException {
			// TODO Auto-generated method stub
			return null;
		}
