...
public class NonTaggedDataFormat implements IDataFormat {
    ...
    public void registerRuntimeFunctions() throws AlgebricksException {
        ...
        temp.add(new NumericAbsDescriptor());
        temp.add(new NumericCeilingDescriptor());
        temp.add(new NumericFloorDescriptor());
        temp.add(new NumericRoundDescriptor());
        temp.add(new NumericRoundHalfToEvenDescriptor());
        temp.add(new NumericRoundHalfToEven2Descriptor());
        // String functions
        temp.add(new StringEqualDescriptor());
        temp.add(new StringStartWithDescrtiptor());    
        temp.add(new StringEndWithDescrtiptor());       
        temp.add(new StringMatchesDescriptor());    
        temp.add(new StringLowerCaseDescriptor());   
        temp.add(new StringMatchesWithFlagDescriptor());
        temp.add(new StringReplaceDescriptor());      
        temp.add(new StringReplaceWithFlagsDescriptor());    
        temp.add(new StringLengthDescriptor());        
        temp.add(new Substring2Descriptor());    
        temp.add(new SubstringBeforeDescriptor()); 
        temp.add(new SubstringAfterDescriptor()); 
        temp.add(new StringToCodePointDescriptor());         
        temp.add(new CodePointToStringDescriptor()); 
        temp.add(new StringConcatDescriptor());         
        temp.add(new StringJoinDescriptor());      
