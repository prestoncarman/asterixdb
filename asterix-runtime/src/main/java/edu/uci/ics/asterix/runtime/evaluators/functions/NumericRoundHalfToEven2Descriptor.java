        ...
        return new IEvaluatorFactory() {
            ...
            public IEvaluator createEvaluator(final IDataOutputProvider output) throws AlgebricksException {
                ...
                return new IEvaluator() {
                    ...
                    private IEvaluator precision = args[1].createEvaluator(argOut);
                    ...
                    private int getPrecision(IFrameTupleReference tuple) throws AlgebricksException {
                        ...
                        if(argOut.getBytes()[0] == serInt8TypeTag) {
                            return (int)AInt8SerializerDeserializer.getByte(argOut.getBytes(), 1);                          
                        } else if(argOut.getBytes()[0] == serInt16TypeTag) {
                            return (int)AInt16SerializerDeserializer.getShort(argOut.getBytes(), 1);       
                        } else if(argOut.getBytes()[0] == serInt32TypeTag) {
                            return (int)AInt32SerializerDeserializer.getInt(argOut.getBytes(), 1);       
                        } else if(argOut.getBytes()[0] == serInt64TypeTag) {
                            return (int)AInt64SerializerDeserializer.getLong(argOut.getBytes(), 1);       
                        } else if(argOut.getBytes()[0] == serFloatTypeTag) {
                            return (int)AFloatSerializerDeserializer.getFloat(argOut.getBytes(), 1);       
                        } else if(argOut.getBytes()[0] == serDoubleTypeTag) {
                            return (int)ADoubleSerializerDeserializer.getDouble(argOut.getBytes(), 1);       
                        }
