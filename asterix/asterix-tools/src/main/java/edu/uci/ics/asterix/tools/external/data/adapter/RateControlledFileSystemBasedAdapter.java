...
public class RateControlledFileSystemBasedAdapter extends FileSystemBasedAdapter implements IFeedDatasourceAdapter {
    ...
    public static final String KEY_OUTPUT_TYPE_NAME = "output-type-name";
    public static final String KEY_OUTPUT_TYPE_DATAVERSE = "output-type-dataverse";
    ...
    public RateControlledFileSystemBasedAdapter(Map<String, String> configuration, IAType type) throws Exception {
        super(type);
    ...
    protected ITupleParser getRateControlledADMDataTupleParser(ARecordType recordType) throws AsterixException {
        return new RateControlledTupleParserFactory(recordType, configuration).createTupleParser(ctx);
    }
