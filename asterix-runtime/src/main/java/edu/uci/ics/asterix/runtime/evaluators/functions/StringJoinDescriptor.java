        ...
        return new IEvaluatorFactory() {
            ...
            public IEvaluator createEvaluator(final IDataOutputProvider output) throws AlgebricksException {
                return new IEvaluator() {
                    ...
                    private IEvaluatorFactory listEvalFactory = args[0];
                    private IEvaluatorFactory sepEvalFactory = args[1];                    
                    ...
                    private IEvaluator evalSep = sepEvalFactory.createEvaluator(outInputSep);                    
                    ...
                    public void evaluate(IFrameTupleReference tuple) throws AlgebricksException {
                        try {
                            ...
                            byte[] serSep = outInputSep.getBytes();
                            boolean noSep = false;
                            ...
                            try {
                                ...
                                int utf_8_len = 0;
                                int sep_len = UTF8StringPointable.getUTFLen(serSep, 1);
                                
                                for (int i = 0; i < size; i++) {
                                    int itemOffset = AOrderedListSerializerDeserializer.getItemOffset(serOrderedList, i);                                                                        
                                    int currentSize = UTF8StringPointable.getUTFLen(serOrderedList, itemOffset);  
                                ...
                                for (int i = 0; i < size; i++) {
                                    int itemOffset = AOrderedListSerializerDeserializer.getItemOffset(serOrderedList, i);
                                    utf_8_len = UTF8StringPointable.getUTFLen(serOrderedList, itemOffset);        
