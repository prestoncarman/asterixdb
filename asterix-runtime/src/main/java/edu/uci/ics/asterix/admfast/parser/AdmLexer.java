...
public class AdmLexer {
    ...
    private int parse_POINT_LITERAL(char currentChar) throws IOException, AdmLexerException{
if (currentChar=='P'){
currentChar = readNextChar();
if (parse_DOUBLE_LITERAL(currentChar)==TOKEN_DOUBLE_LITERAL){
if (currentChar==','){
currentChar = readNextChar();
if (parse_DOUBLE_LITERAL(currentChar)==TOKEN_DOUBLE_LITERAL){
if (currentChar=='R'){
currentChar = readNextChar();
if (parse_DOUBLE_LITERAL(currentChar)==TOKEN_DOUBLE_LITERAL){
return TOKEN_CIRCLE_LITERAL;
}return parseError(TOKEN_CIRCLE_LITERAL);
}if (currentChar==','){
currentChar = readNextChar();
if (parse_DOUBLE_LITERAL(currentChar)==TOKEN_DOUBLE_LITERAL){
return TOKEN_POINT3D_LITERAL;
}return parseError(TOKEN_POINT3D_LITERAL);
}if (parse_POINT_LITERAL(currentChar)==TOKEN_POINT_LITERAL){
if (parse_POINT_LITERAL(currentChar)==TOKEN_POINT_LITERAL){
return TOKEN_RECTANGLE_LITERAL;
}return TOKEN_LINE_LITERAL;
}return TOKEN_POINT_LITERAL;
}return parseError(TOKEN_LINE_LITERAL,TOKEN_RECTANGLE_LITERAL,TOKEN_POINT3D_LITERAL,TOKEN_POINT_LITERAL,TOKEN_CIRCLE_LITERAL);
}return parseError(TOKEN_LINE_LITERAL,TOKEN_RECTANGLE_LITERAL,TOKEN_POINT3D_LITERAL,TOKEN_POINT_LITERAL,TOKEN_CIRCLE_LITERAL);
}return parseError(TOKEN_LINE_LITERAL,TOKEN_RECTANGLE_LITERAL,TOKEN_POINT3D_LITERAL,TOKEN_POINT_LITERAL,TOKEN_CIRCLE_LITERAL);
...
private int parse_aux_DURATION_TIME_PART(char currentChar) throws IOException, AdmLexerException{
...
case 'H':
currentChar = readNextChar();
return TOKEN_aux_DURATION_TIME_PART;
case 'M':
currentChar = readNextChar();
return TOKEN_aux_DURATION_TIME_PART;
case 'S':
...
return parseError(TOKEN_aux_DURATION_TIME_PART);

}return TOKEN_AUX_NOT_FOUND;

}

private int parse_DOUBLE_LITERAL(char currentChar) throws IOException, AdmLexerException{
switch(currentChar){
case '+':
currentChar = readNextChar();
if (currentChar=='.'){
...
}return parseError(TOKEN_DOUBLE_LITERAL);
...
private int parse_aux_DURATION_DATE_PART(char currentChar) throws IOException, AdmLexerException{
if(currentChar >= '0' && currentChar<='9'){
currentChar = readNextChar();
while(currentChar >= '0' && currentChar<='9'){
currentChar = readNextChar();
...
case 'Y':
currentChar = readNextChar();
return TOKEN_aux_DURATION_DATE_PART;
case 'M':
currentChar = readNextChar();
return TOKEN_aux_DURATION_DATE_PART;
case 'D':
...
return parseError(TOKEN_aux_DURATION_DATE_PART);

}return TOKEN_AUX_NOT_FOUND;

}

private int parse_aux_TIMEZONE(char currentChar) throws IOException, AdmLexerException{
switch(currentChar){
case 'Z':
currentChar = readNextChar();
return TOKEN_aux_TIMEZONE;
case '+':
currentChar = readNextChar();
if(currentChar >= '0' && currentChar<='9'){
currentChar = readNextChar();
...
}return parseError(TOKEN_aux_TIMEZONE);
}return parseError(TOKEN_aux_TIMEZONE);
...
if (parse_aux_TIMEZONE(currentChar)==TOKEN_aux_TIMEZONE){
return TOKEN_DATE_LITERAL;
}if (currentChar=='T'){
currentChar = readNextChar();
if(currentChar >= '0' && currentChar<='9'){
currentChar = readNextChar();
...
if (parse_aux_TIMEZONE(currentChar)==TOKEN_aux_TIMEZONE){
return TOKEN_DATETIME_LITERAL;
}return parseError(TOKEN_DATETIME_LITERAL);

}return parseError(TOKEN_DATETIME_LITERAL);
}return parseError(TOKEN_DATETIME_LITERAL);

}return parseError(TOKEN_aux_DATETIME_PARTIAL,TOKEN_DATETIME_LITERAL);
}return parseError(TOKEN_aux_DATETIME_PARTIAL,TOKEN_DATETIME_LITERAL);
...
}return parseError(TOKEN_aux_DATETIME_PARTIAL,TOKEN_DATETIME_LITERAL,TOKEN_DATE_LITERAL);
...
currentChar = readNextChar();
if (parse_aux_DURATION_DATE_PART(currentChar)==TOKEN_aux_DURATION_DATE_PART){
if (parse_aux_DURATION_DATE_PART(currentChar)==TOKEN_aux_DURATION_DATE_PART){
if (parse_aux_DURATION_DATE_PART(currentChar)==TOKEN_aux_DURATION_DATE_PART){
if (currentChar=='T'){
currentChar = readNextChar();
if (parse_aux_DURATION_TIME_PART(currentChar)==TOKEN_aux_DURATION_TIME_PART){
if (parse_aux_DURATION_TIME_PART(currentChar)==TOKEN_aux_DURATION_TIME_PART){
if (parse_aux_DURATION_TIME_PART(currentChar)==TOKEN_aux_DURATION_TIME_PART){
return TOKEN_DURATION_LITERAL;
}return parseError(TOKEN_DURATION_LITERAL);
}return parseError(TOKEN_DURATION_LITERAL);
}return parseError(TOKEN_DURATION_LITERAL);
}return TOKEN_DURATION_LITERAL;
}return parseError(TOKEN_DURATION_LITERAL,TOKEN_aux_DURATION_PARTIAL);
}return parseError(TOKEN_DURATION_LITERAL,TOKEN_aux_DURATION_PARTIAL);
}return parseError(TOKEN_DURATION_LITERAL,TOKEN_aux_DURATION_PARTIAL);
}return parseError(TOKEN_INT16_LITERAL,TOKEN_DOUBLE_LITERAL,TOKEN_aux_DATETIME_PARTIAL,TOKEN_DATETIME_LITERAL,TOKEN_INT64_LITERAL,TOKEN_INT_LITERAL,TOKEN_DURATION_LITERAL,TOKEN_DATE_LITERAL,TOKEN_INT8_LITERAL,TOKEN_INT32_LITERAL,TOKEN_aux_DURATION_PARTIAL,TOKEN_FLOAT_LITERAL);
case '.':
currentChar = readNextChar();
if(currentChar >= '0' && currentChar<='9'){
currentChar = readNextChar();
...
if (parse_aux_TIMEZONE(currentChar)==TOKEN_aux_TIMEZONE){
return TOKEN_TIME_LITERAL;
}return parseError(TOKEN_TIME_LITERAL);
...
}return parseError(TOKEN_CONSTRUCTOR_OPEN,TOKEN_FALSE_LITERAL,TOKEN_END_UNORDERED_LIST,TOKEN_aux_DATETIME_PARTIAL,TOKEN_POINT3D_LITERAL,TOKEN_INT64_LITERAL,TOKEN_POLYGON_CONS,TOKEN_START_RECORD,TOKEN_BOOLEAN_CONS,TOKEN_DURATION_CONS,TOKEN_CIRCLE_CONS,TOKEN_FLOAT_LITERAL,TOKEN_START_ORDERED_LIST,TOKEN_DOUBLE_LITERAL,TOKEN_TIME_CONS,TOKEN_FLOAT_CONS,TOKEN_POINT3D_CONS,TOKEN_COMMA,TOKEN_INT16_LITERAL,TOKEN_START_UNORDERED_LIST,TOKEN_POINT_CONS,TOKEN_INT32_CONS,TOKEN_DATE_CONS,TOKEN_DOUBLE_CONS,TOKEN_DURATION_LITERAL,TOKEN_POINT_LITERAL,TOKEN_NULL_LITERAL,TOKEN_INT8_CONS,TOKEN_RECTANGLE_LITERAL,TOKEN_RECTANGLE_CONS,TOKEN_STRING_LITERAL,TOKEN_INT_LITERAL,TOKEN_DATETIME_LITERAL,TOKEN_DATE_LITERAL,TOKEN_INT16_CONS,TOKEN_CIRCLE_LITERAL,TOKEN_LINE_LITERAL,TOKEN_TRUE_LITERAL,TOKEN_LINE_CONS,TOKEN_INT32_LITERAL,TOKEN_COLON,TOKEN_END_RECORD,TOKEN_TIME_LITERAL,TOKEN_END_ORDERED_LIST,TOKEN_aux_DURATION_PARTIAL,TOKEN_DATETIME_CONS,TOKEN_INT8_LITERAL,TOKEN_CONSTRUCTOR_CLOSE,TOKEN_STRING_CONS,TOKEN_INT64_CONS);
