 ...
 * @author ilovesoup
 */
public abstract class AbstractQuadStringStringEval implements IEvaluator   {
    ...
    public AbstractQuadStringStringEval(DataOutput dout, IEvaluatorFactory eval0,
            IEvaluatorFactory eval1, IEvaluatorFactory eval2, IEvaluatorFactory eval3) throws AlgebricksException {
        this.dout = dout;
    ...
    public void evaluate(IFrameTupleReference tuple) throws AlgebricksException {
        ...
        try {
            if (array0.getBytes()[0] == SER_NULL_TYPE_TAG) {
                ...
                return;
            } else if (array0.getBytes()[0] == SER_STRING_TYPE_TAG) {
                if(array0.getBytes()[1] == SER_NULL_TYPE_TAG) {
                    dout.write(array0.getBytes(), array0.getStartIndex(), array0.getLength());
                    return;
                }
