...
public interface IMetadataNode extends Remote, Serializable {
	 ...
	 */
	public void beginTransaction(long txnId) throws ACIDException,
			RemoteException;
	 ...
	 * @throws RemoteException
	 */
	public void commitTransaction(long txnId) throws ACIDException,
			RemoteException;
	 ...
	 * @throws RemoteException
	 */
	public void abortTransaction(long txnId) throws ACIDException,
			RemoteException;
	 ...
	 * @throws RemoteException
	 */
	public boolean lock(long txnId, int lockMode) throws ACIDException,
			RemoteException;
	 ...
	 * @throws RemoteException
	 */
	public void addDataverse(long txnId, Dataverse dataverse)
	 ...
	 * @throws RemoteException
	 */
	public Dataverse getDataverse(long txnId, String dataverseName)
			throws MetadataException, RemoteException;
	 ...
	 */
	public List<Dataset> getDataverseDatasets(long txnId, String dataverseName)
			throws MetadataException, RemoteException;
	 ...
	 * @throws RemoteException
	 */
	public void dropDataverse(long txnId, String dataverseName)
			throws MetadataException, RemoteException;
	 ...
	 * @throws RemoteException
	 */
	public void addDataset(long txnId, Dataset dataset)
			throws MetadataException, RemoteException;
	 ...
	 * @throws RemoteException
	 */
	public Dataset getDataset(long txnId, String dataverseName,
			String datasetName) throws MetadataException, RemoteException;
	 ...
	 * @throws RemoteException
	 */
	public List<Index> getDatasetIndexes(long txnId, String dataverseName,
			String datasetName) throws MetadataException, RemoteException;
	 ...
	 * @throws RemoteException
	 */
	public void dropDataset(long txnId, String dataverseName, String datasetName)
			throws MetadataException, RemoteException;
	 ...
	 * @throws RemoteException
	 */
	public void addIndex(long txnId, Index index) throws MetadataException,
			RemoteException;
	 ...
	 * @throws RemoteException
	 */
	public Index getIndex(long txnId, String dataverseName, String datasetName,
			String indexName) throws MetadataException, RemoteException;
	 ...
	 * @throws RemoteException
	 */
	public void dropIndex(long txnId, String dataverseName, String datasetName,
			String indexName) throws MetadataException, RemoteException;
	 ...
	 * @throws RemoteException
	 */
	public void addDatatype(long txnId, Datatype datatype)
			throws MetadataException, RemoteException;
	 ...
	 * @throws RemoteException
	 */
	public Datatype getDatatype(long txnId, String dataverseName,
	 ...
	 * @throws RemoteException
	 */
	public void dropDatatype(long txnId, String dataverseName,
			String datatypeName) throws MetadataException, RemoteException;
	 ...
	 * @throws RemoteException
	 */
	public void addNodeGroup(long txnId, NodeGroup nodeGroup)
			throws MetadataException, RemoteException;
	 ...
	 * @throws RemoteException
	 */
	public NodeGroup getNodeGroup(long txnId, String nodeGroupName)
			throws MetadataException, RemoteException;
	 ...
	 * @throws RemoteException
	 */
	public void dropNodegroup(long txnId, String nodeGroupName)
			throws MetadataException, RemoteException;
	 ...
	 * @throws RemoteException
	 */
	public void addNode(long txnId, Node node) throws MetadataException,
			RemoteException;
	 ...
	 * @param adapterName
	 *            Name of adapter to be deleted.
	 * @return
	 * @throws RemoteException
	 */
	public Adapter getAdapter(long txnId, String dataverseName,
			String adapterName) throws MetadataException, RemoteException;
	 ...
	 * @throws RemoteException
	 */
	public void dropAdapter(long txnId, String dataverseName, String adapterName)
			throws MetadataException, RemoteException;
	 ...
	 * @throws RemoteException
	 */
	public void addAdapter(long txnId, Adapter adapter)
			throws MetadataException, RemoteException;
