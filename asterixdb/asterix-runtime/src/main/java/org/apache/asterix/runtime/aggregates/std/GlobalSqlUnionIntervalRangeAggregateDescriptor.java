...
public class GlobalSqlUnionIntervalRangeAggregateDescriptor extends AbstractUnionIntervalRangeAggregateDescriptor {
    ...
    public static final org.apache.asterix.om.functions.IFunctionDescriptorFactory FACTORY =
            org.apache.asterix.runtime.aggregates.base.AbstractAggregateFunctionDynamicDescriptor
                    .createFactory(GlobalSqlUnionIntervalRangeAggregateDescriptor::new);

    @Override
    public org.apache.hyracks.algebricks.core.algebra.functions.FunctionIdentifier getIdentifier() {
        return org.apache.asterix.om.functions.BuiltinFunctions.GLOBAL_SQL_UNION_INTERVAL_RANGE;
    }
