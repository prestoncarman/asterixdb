...
public class FunctionUtil {
    ...
    public static FunctionDecl getFunctionDecl(Function function) throws AsterixException {
        ...
        builder.append(" declare function " + unmangleFunctionName(function.getFunctionName())[0]);
        builder.append("(");
        ...
        return (FunctionDecl) query.getPrologDeclList().get(0);
    }

    public static String mangleFunctionName(String functionName ,int arity){
        return functionName;// + "@" + arity;
    }
    
    public static String[] unmangleFunctionName(String mangledFunctionName){
        return new String[]{mangledFunctionName} ;//mangledFunctionName.split("@");
    }
}
