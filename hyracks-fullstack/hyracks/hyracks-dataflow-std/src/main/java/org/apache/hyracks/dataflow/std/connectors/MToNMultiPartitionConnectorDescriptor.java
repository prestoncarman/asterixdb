...
public class MToNMultiPartitionConnectorDescriptor extends AbstractMToNConnectorDescriptor {
    private static final long serialVersionUID = 1L;
    protected ITuplePartitionComputerFactory tpcf;

    public MToNMultiPartitionConnectorDescriptor(IConnectorDescriptorRegistry spec, ITuplePartitionComputerFactory tpcf) {
        super(spec);
        this.tpcf = tpcf;
    }
