...
public abstract class SecondaryIndexCreator {
    ...
    protected IEvaluatorFactory[] secondaryFieldAccessEvalFactories;
    ...
    protected AlgebricksMetaOperatorDescriptor createAssignOp(JobSpecification spec,
        ...
        AssignRuntimeFactory assign = new AssignRuntimeFactory(outColumns, secondaryFieldAccessEvalFactories, projectionList);
