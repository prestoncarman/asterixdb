...
public class PullBasedTwitterFeedClient extends PullBasedFeedClient {
	...
	public PullBasedTwitterFeedClient(IHyracksTaskContext ctx,
			PullBasedTwitterAdapter adapter) {
		this.id_prefix = ctx.getJobletContext().getApplicationContext()
				.getNodeId();
	...
	public boolean setNextRecord() throws Exception {
		...
		tupleFieldValues[2] = tweet.getLocation() == null ? "" : tweet
				.getLocation();
