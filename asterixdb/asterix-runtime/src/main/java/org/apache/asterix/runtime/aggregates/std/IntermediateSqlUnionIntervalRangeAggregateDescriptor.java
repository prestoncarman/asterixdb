...
public class IntermediateSqlUnionIntervalRangeAggregateDescriptor
        extends AbstractUnionIntervalRangeAggregateDescriptor {
    ...
    public static final org.apache.asterix.om.functions.IFunctionDescriptorFactory FACTORY =
            org.apache.asterix.runtime.aggregates.base.AbstractAggregateFunctionDynamicDescriptor
                    .createFactory(IntermediateSqlUnionIntervalRangeAggregateDescriptor::new);

    @Override
    public org.apache.hyracks.algebricks.core.algebra.functions.FunctionIdentifier getIdentifier() {
        return org.apache.asterix.om.functions.BuiltinFunctions.INTERMEDIATE_SQL_UNION_INTERVAL_RANGE;
    }
    ...
    public org.apache.hyracks.algebricks.runtime.base.IAggregateEvaluatorFactory createAggregateEvaluatorFactory(
        ...
        return new org.apache.hyracks.algebricks.runtime.base.IAggregateEvaluatorFactory() {
            ...
            public org.apache.hyracks.algebricks.runtime.base.IAggregateEvaluator createAggregateEvaluator(
                ...
                return new org.apache.asterix.runtime.aggregates.std.SqlUnionIntervalRangeAggregateFunction(args, ctx,
                        sourceLoc);
            }
        };
    }
