...
public class IntermediateUnionIntervalRangeAggregateDescriptor extends AbstractUnionIntervalRangeAggregateDescriptor {
    ...
    public static final org.apache.asterix.om.functions.IFunctionDescriptorFactory FACTORY =
            org.apache.asterix.runtime.aggregates.base.AbstractAggregateFunctionDynamicDescriptor
                    .createFactory(IntermediateUnionIntervalRangeAggregateDescriptor::new);

    @Override
    public org.apache.hyracks.algebricks.core.algebra.functions.FunctionIdentifier getIdentifier() {
        return org.apache.asterix.om.functions.BuiltinFunctions.INTERMEDIATE_UNION_INTERVAL_RANGE;
    }
