...
public class IndexOperations {
    ...
    public static JobSpecification createRtreeIndexJobSpec(CompiledCreateIndexStatement createIndexStmt,
        ...
        /*
         * ITreeIndexFrameFactory secondaryInteriorFrameFactory =
         * JobGenHelper.createRTreeNSMInteriorFrameFactory( secondaryTypeTraits,
         * numNestedSecondaryKeyFields); ITreeIndexFrameFactory
         * secondaryLeafFrameFactory =
         * JobGenHelper.createRTreeNSMLeafFrameFactory( secondaryTypeTraits,
         * numNestedSecondaryKeyFields);
         */
