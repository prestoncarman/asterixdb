...
public class SimilarityJaccardSortedEvaluator implements IEvaluator {
    ...
    public SimilarityJaccardSortedEvaluator(IEvaluatorFactory[] args, IDataOutputProvider output) throws AlgebricksException {
